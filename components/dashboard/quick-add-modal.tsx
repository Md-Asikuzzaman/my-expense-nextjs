  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger
        render={
          ...
          >
            <Button
              size='lg'
              className='rounded-full shadow-lg h-12 px-6 gap-2 bg-gradient-to-r from-indigo-500 to-violet-500 hover:from-indigo-600 hover:to-violet-600'
            >
      ...
      <motion.button
        ...
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.9 }}
        className='sm:hidden fixed right-4 bottom-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-violet-500 text-white shadow-lg'
