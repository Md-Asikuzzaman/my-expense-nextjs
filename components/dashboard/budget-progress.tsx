          ...
          <motion.div initial="initial" animate="animate" className="space-y-4">
            {(() => {
              ...
              return sortedBudgets.map((budget, index) => {
                ...
                const alert =
                  pct >= 100 ? "danger" : pct >= 80 ? "warn" : "safe";
                  ...
                  >
                    ...
                    <Progress
                      ...
                      className={cn(
                        ...
                        alert === "danger" &&
                          "[&_[data-slot=progress-track]]:bg-rose-200 dark:[&_[data-slot=progress-track]]:bg-rose-900/60",
                        alert === "warn" &&
                          "[&_[data-slot=progress-track]]:bg-amber-200 dark:[&_[data-slot=progress-track]]:bg-amber-900/60",
                        // Indicator colors
                        alert === "danger" &&
