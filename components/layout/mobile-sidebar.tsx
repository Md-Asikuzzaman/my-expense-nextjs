...
import { SpiderLogoSmall } from '@/components/spider-logo';
  ...
  return (
    <header className='sticky top-0 z-40 w-full border-b border-border/60 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 lg:hidden'>
      <div className='flex h-14 items-center justify-between px-4'>
        ...
        >
          <SpiderLogoSmall className='shrink-0' />
          <span className='bg-gradient-to-r from-[#DC2626] to-[#0891B2] bg-clip-text text-lg font-bold text-transparent'>
            {APP_NAME}
          </span>
        </Link>
      ...
      <div className='flex flex-col h-full'>
        ...
        <div className='flex h-16 items-center border-b border-border/60 px-6'>
          <Link href='/dashboard' className='flex items-center gap-2'>
            <SpiderLogoSmall className='shrink-0' />
            <span className='bg-gradient-to-r from-[#DC2626] to-[#0891B2] bg-clip-text text-xl font-bold text-transparent'>
              {APP_NAME}
            </span>
          </Link>
        </div>
